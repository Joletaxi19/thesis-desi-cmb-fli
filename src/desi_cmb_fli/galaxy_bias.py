"""Galaxy bias and noise modeling.

This module provides functions to model galaxy bias and observational noise,
transforming matter density fields into observed galaxy fields.

Key components:
- Lagrangian bias expansion (LBE) for galaxy-halo connection
...
from desi_cmb_fli.evolution import a2f, a2g, invlaplace_kernel, rfftk

# Import utility functions from local modules
from desi_cmb_fli.initial_conditions import ch2rshape, safe_div
